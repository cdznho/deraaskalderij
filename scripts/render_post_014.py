...
SRC = ROOT / "assets" / "posts" / "014-vs-250-navo-photo.png"
OUT = ROOT / "assets" / "posts" / "014-vs-250-navo.png"
...
def main():
    ...
    draw.text((70, 58), "BUITENLAND", font=font(ARIAL_BOLD, 32), fill=WHITE)
    draw.ellipse((980, 58, 1018, 96), fill=ORANGE)

    headline = "VS viert 250e verjaardag, Europa vraagt of cadeau meetelt als NAVO-bijdrage"
    ...
    deck_y = y + 54
    for line in wrap(draw, "Belgie komt met kaart, glimlach en btw-bon.", deck_font, 720):
