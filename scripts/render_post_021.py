...
SRC = ROOT / "assets" / "sources" / "021-gent-matcha-spill.png"
OUT = ROOT / "assets" / "posts" / "021-gent-matcha-latte.png"
...
def draw_stamp(draw):
    draw.rectangle((70, 725, 310, 765), fill=ORANGE)
    draw.text((92, 733), "KOKOSMELK CODE", font=font(ARIAL_BOLD, 18), fill=INK)
    draw.rectangle((738, 725, 1010, 779), fill=(17, 17, 17, 225))
    draw.text((760, 739), "TERRASALARM", font=font(ARIAL_BOLD, 24), fill=PAPER)
...
def main():
    ...
    draw.text((70, 58), "GENT", font=font(ARIAL_BOLD, 32), fill=WHITE)
    draw.ellipse((936, 58, 974, 96), fill=GREEN)
    draw.ellipse((980, 58, 1018, 96), fill=ORANGE)
    draw_stamp(draw)

    headline = "Hipster morst dirty iced matcha coco latte in Gent"
    ...
    deck = "Laptop bleef droog en Claude deed gewoon verder met het werk van de hipster."
    deck_y = y + 54
