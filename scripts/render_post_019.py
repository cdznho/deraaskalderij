...
SRC = ROOT / "assets" / "sources" / "019-dewever-real.png"
OUT = ROOT / "assets" / "posts" / "019-dewever-secret-santa.png"
...
def draw_stamp(draw):
    ...
    draw.text((92, 733), "NAVO-GOODIEBAG", font=font(ARIAL_BOLD, 18), fill=INK)
    draw.rectangle((716, 725, 1010, 779), fill=(17, 17, 17, 215))
    draw.text((738, 739), "MELSBROEK CHECK", font=font(ARIAL_BOLD, 23), fill=PAPER)
    draw.ellipse((962, 737, 992, 767), fill=ORANGE)
...
def main():
    ...
    draw.text((70, 58), "POLITIEK", font=font(ARIAL_BOLD, 32), fill=WHITE)
    draw.ellipse((980, 58, 1018, 96), fill=ORANGE)
    draw_stamp(draw)

    headline = "De Wever ontdekt dat Erdogan Secret Santa iets te letterlijk neemt"
    ...
    deck = "Melsbroek vraagt voortaan bij elke goodiebag: zit er nog geopolitiek in?"
    deck_y = y + 54
    for line in wrap(draw, deck, deck_font, 780):
